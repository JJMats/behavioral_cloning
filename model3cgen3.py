        ...
        for offset in range(0, n_images, batch_size):
            ...
            for batch_image in batch_images:
                for i in range(3):
                    ...
                    #mpimg.imsave("output_images/raw/raw_image" + str(i) + ".png", img)
                    #cropped_image = img[70:136, 0:320]
                    #mpimg.imsave("output_images/cropped/cropped_image" + str(i) + ".png", cropped_image)
                #exit()
            ...
            for img, meas in zip(imgs, measurements):
                ...
                print("saving flipped image", i)
                mpimg.imsave("output_images/flipped/flipped_image" + str(i) + ".png", img_flipped)
                i += 1
                if i == 3:
                    exit()    
