...
model.add(Conv2D(24, 5, 5, activation='tanh', subsample=(2, 2))) #Input 3@66x320, Output 24@31x98
#model.add(MaxPooling2D())
#model.add(Dropout(0.25))

model.add(Conv2D(36, 5, 5, activation='tanh', subsample=(2, 2))) #Input 24@31x98, Output 36@14x47
#model.add(MaxPooling2D())

model.add(Conv2D(48, 5, 5, activation='tanh', subsample=(2, 2))) #Input 36@14x47, Output 48@5x22
#model.add(MaxPooling2D())

model.add(Conv2D(64, 3, 3, activation='tanh')) #Input 48@5x22, Output 64@3x20
#model.add(MaxPooling2D())

# Add second convolutional layer
model.add(Conv2D(64, 3, 3, activation='tanh')) #Input 64@3x20, Output 64@1x18
#model.add(MaxPooling2D())
